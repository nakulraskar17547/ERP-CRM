...
![Tech Stack](https://img.shields.io/badge/Express-4.21-lightgrey)
![Tech Stack](https://img.shields.io/badge/Prisma-5.22-indigo)
![Tech Stack](https://img.shields.io/badge/React-19.0-cyan)
...
* **Frontend:** https://erp-crm-git-main-nakul8.vercel.app/
* **Backend API:** https://erp-crm-yepk.onrender.com/api
...
* **Database ORM**: Prisma  (Code to database interface)
...
```env
VITE_API_URL="https://erp-crm-yepk.onrender.com/api"
```
...
1. Create a project on Vercel linked to your repository.
...
https://erp-crm-yepk.onrender.com/api

---

## 👨‍💻 Project Overview

This Mini ERP + CRM Operations Portal provides a centralized platform for managing customers, products, inventory, stock movements, sales challans, authentication, and role-based access control.

The system is designed to improve operational visibility, inventory accuracy, customer relationship management, and sales workflow management for wholesale and distribution businesses.
